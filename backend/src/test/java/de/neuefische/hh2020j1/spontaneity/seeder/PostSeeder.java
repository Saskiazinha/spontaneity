...
public class PostSeeder {
    ...
    public static final List<Post> getStockPostsSorted(){
        return new ArrayList<>(List.of(
                ...
                new Post("222", "Rebekka", Instant.parse("2020-11-20T09:30:00.00Z"), Instant.parse("2020-11-20T12:30:00.00Z"),EnumStatus.YELLOW,"Altona" , EnumStatus.YELLOW, EnumCategory.Exercise,EnumStatus.GREEN, "I would like to do some exercise", Instant.parse("2020-11-20T10:56:04Z")),
    ...
    public static final List<SendPostDto> getStockSendPostsDtoSorted(){
        return new ArrayList<SendPostDto>(List.of(
                ...
                new SendPostDto("222", "Rebekka", LocalDate.of(2020,11,20),LocalTime.of(10,30), LocalTime.of(13,30),EnumStatus.YELLOW,"Altona" , EnumStatus.YELLOW, EnumCategory.Exercise,EnumStatus.GREEN, "I would like to do some exercise", Instant.parse("2020-11-20T10:56:04Z")),
